...
import moime.feature.friend.generated.resources.my_friend
import moime.feature.friend.generated.resources.recommended_friend
import org.jetbrains.compose.resources.StringResource
import org.jetbrains.compose.resources.stringResource
import team.capybara.moime.core.ui.model.SubTab

internal sealed class FriendSubTab(
    override val titleTextRes: StringResource
) : SubTab {
    data class MyFriend(
        val friendCount: Int,
        override val titleTextRes: StringResource = Res.string.my_friend
    ) : FriendSubTab(titleTextRes) {
